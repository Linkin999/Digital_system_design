...
{
	iki_sensitize(dp, "xsim.dir/test_repetitive_time_impl/xsim.reloc");
}
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1169720, dp + 1170968, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1169776, dp + 1171920, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1169832, dp + 1175224, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1169944, dp + 1172032, 0, 15, 0, 15, 16, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1169984, dp + 1172256, 0, 15, 0, 15, 16, 1);

}

void simulate(char *dp)
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/test_repetitive_time_impl/xsim.reloc");
	wrapper_func_0(dp);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/test_repetitive_time_impl/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/test_repetitive_time_impl/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/test_repetitive_time_impl/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, (void*)0, 0, isimBridge_getWdbWriter(), 0, argc, argv);
